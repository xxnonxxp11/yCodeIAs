    ...
    fun environment(
        ...
        localRuntimeEnvironment(runtime.commandSuite.environment(), tmp) +
            mapOf(
                ...
                "ANTIGRAVITY_DISABLE_TELEMETRY" to "1",
                "ANTIGRAVITY_DISABLE_AUTO_UPDATE" to "1",
                "ANTIGRAVITY_NO_UPDATE_NOTIFIER" to "1",
                "NODE_OPTIONS" to "--max-old-space-size=2048 --no-warnings",
                "UV_THREADPOOL_SIZE" to "8",
